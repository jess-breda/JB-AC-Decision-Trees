# config.py
"""
Quick script to set up paths for the decision tree project
...
elif "athena" in str(current_path):
    data_path = Path("/Users/athenacasarotto/JB-AC-Decision-Trees/data")
    src_path = Path("/Users/athenacasarotto/JB-AC-Decision-Trees/src")
else:
